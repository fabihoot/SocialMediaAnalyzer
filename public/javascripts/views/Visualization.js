SocialMediaAnalyzer.Visualization = (function() {
  ...
  onRequestFinished = function(event){
    ...
    var colorClasses = ['.facebook', '.twitter', '.reddit'];
    var width = 100, height = 350;
    var barWidth = 75;
    var duration = 2000;
